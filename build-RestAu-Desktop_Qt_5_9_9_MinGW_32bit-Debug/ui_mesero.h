...
""));
        ...
        Salir->setStyleSheet(QLatin1String("QPushButton\n"
"{\n"
...
"}"));
        ...
        Buscar->setStyleSheet(QLatin1String("QPushButton\n"
"{\n"
"  border:0px solid gray;\n"
"  padding: 0 8px;\n"
"  background: yellow;\n"
...
"}"));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/img/Iconos/lupa.png"), QSize(), QIcon::Normal, QIcon::Off);
        Buscar->setIcon(icon1);
        Buscar->setIconSize(QSize(30, 30));
        NuevoPedido = new QPushButton(widget);
        NuevoPedido->setObjectName(QStringLiteral("NuevoPedido"));
        NuevoPedido->setGeometry(QRect(10, 180, 131, 61));
        NuevoPedido->setStyleSheet(QLatin1String("QPushButton\n"
"{\n"
"  border:0px solid gray;\n"
"  padding: 0 8px;\n"
"  background: yellow;\n"
...
"}"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/img/Iconos/anadir.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        stackedWidget->setStyleSheet(QStringLiteral("background-color: #faf4ee;"));
        page = new QWidget();
...
"border-radius: 10px;"));
        ...
        TablaPlatillos->setObjectName(QStringLiteral("TablaPlatillos"));
        TablaPlatillos->setGeometry(QRect(20, 130, 641, 341));
        TablaPlatillos->setStyleSheet(QStringLiteral("background-color: white;"));
        stackedWidget->addWidget(page);
        page_2 = new QWidget();
        page_2->setObjectName(QStringLiteral("page_2"));
        listamenu = new QListWidget(page_2);
        listamenu->setObjectName(QStringLiteral("listamenu"));
        listamenu->setGeometry(QRect(20, 30, 251, 121));
        listamenu->setStyleSheet(QLatin1String("background-color:white;\n"
""));
        listapedido = new QListWidget(page_2);
        listapedido->setObjectName(QStringLiteral("listapedido"));
        listapedido->setGeometry(QRect(380, 100, 256, 291));
        listapedido->setStyleSheet(QStringLiteral("background-color:white;"));
        bebidas = new QListWidget(page_2);
        bebidas->setObjectName(QStringLiteral("bebidas"));
        bebidas->setGeometry(QRect(20, 190, 256, 121));
        bebidas->setStyleSheet(QStringLiteral("background-color:white;"));
        postres = new QListWidget(page_2);
        postres->setObjectName(QStringLiteral("postres"));
        postres->setGeometry(QRect(20, 350, 256, 121));
        postres->setStyleSheet(QStringLiteral("background-color:white;"));
        label_3 = new QLabel(page_2);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(100, 10, 81, 16));
        QFont font1;
        font1.setFamily(QStringLiteral("Caviar Dreams"));
        ...
        CrearPedido->setObjectName(QStringLiteral("CrearPedido"));
        CrearPedido->setGeometry(QRect(560, 410, 111, 51));
        CrearPedido->setStyleSheet(QLatin1String("QPushButton\n"
"{\n"
"  border:0px solid gray;\n"
"  padding: 0 8px;\n"
"  background: yellow;\n"
...
"}"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/img/Iconos/iconfinder_My_order_6457548.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        mesa->setObjectName(QStringLiteral("mesa"));
        mesa->setGeometry(QRect(500, 30, 113, 21));
        mesa->setStyleSheet(QLatin1String("background-color:white;\n"
""));
    ...
    {
        mesero->setWindowTitle(QApplication::translate("mesero", "Dialog", Q_NULLPTR));
        label->setText(QString());
        Salir->setText(QString());
        Buscar->setText(QApplication::translate("mesero", "Buscar", Q_NULLPTR));
        NuevoPedido->setText(QApplication::translate("mesero", "Agregar", Q_NULLPTR));
        label_2->setText(QApplication::translate("mesero", "Buscar Platillos", Q_NULLPTR));
        lineEdit->setPlaceholderText(QApplication::translate("mesero", "ID PLATILLO", Q_NULLPTR));
        label_3->setText(QApplication::translate("mesero", "Desayunos", Q_NULLPTR));
        label_4->setText(QApplication::translate("mesero", "Bebidas", Q_NULLPTR));
        label_5->setText(QApplication::translate("mesero", "Postres", Q_NULLPTR));
        label_6->setText(QApplication::translate("mesero", "Orden", Q_NULLPTR));
        CrearPedido->setText(QApplication::translate("mesero", "Crear Pedido", Q_NULLPTR));
        label_7->setText(QApplication::translate("mesero", "Importe: ", Q_NULLPTR));
        label_8->setText(QApplication::translate("mesero", "No. Mesa:", Q_NULLPTR));
    } // retranslateUi
